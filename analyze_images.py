...
if __name__ == "__main__":
    ...
    store_image_path = r"D:\Zohaib\KIPA23\kidnAI_segmentation\nnUNet_raw_data_base\nnUNet_raw_data\Task001_KidnAI\interpretability\vae_gan\check_data\analysis\images"
    store_analysis_sens = r"D:\Zohaib\KIPA23\kidnAI_segmentation\nnUNet_raw_data_base\nnUNet_raw_data\Task001_KidnAI\interpretability\vae_gan\check_data\analysis\dice_analysis_detected_all"
    ...
    # loading the model
    model = torch.load(os.path.join(model_save_dir, "ct_checkpoint_train_4.pt"))
    ...
    threshold = 0.04  # Tolerance for sensitivity matching

    count_c = 0
    count_miss = 0
    for f in tqdm(os.listdir(store_gt_cor_pred)):
        ...
        label_val = np.load(os.path.join(store_gt_cor_pred, f))
